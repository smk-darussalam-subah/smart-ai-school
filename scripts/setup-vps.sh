...
echo "   R-28: Set AI_PROVIDER=openai, OPENAI_API_KEY=sk-proj-..., OPENAI_CHAT_MODEL=gpt-4.1-mini"
echo "6. Jalankan: docker compose up -d"
echo "   R-31: ollama-init container akan otomatis pull nomic-embed-text (embed model)"
echo "         Tidak perlu manual 'ollama pull' — init container one-shot handle itu."
echo ""
