...
import { findHelpArtifact, genericArtifactUnavailable, streamHelpArtifact } from '@/lib/help/help-artifacts';
...
export async function GET(request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  if (!artifact || artifact.status !== 'ready') return genericArtifactUnavailable();
