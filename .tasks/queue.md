...
> - **▶️ Sisa Sprint 4 (penutup Tahap 1, SERIAL):** ▶️SMA-47 Dashboard KS (Metabase embed) → SMA-52 perf/index → SMA-53 API docs. **Backlog:** OBS-1b (scrub nama tak-berlabel), R-03 hardening (gate aktivasi Claude), **F-3** (`/metrics` publik → batasi internal/auth), N-20 (isolasi DB staging/prod), N-19 (relokasi clone non-sync).
>
