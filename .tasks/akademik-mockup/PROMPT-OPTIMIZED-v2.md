...
- **F3 ✅ COMPLETED (partial — Phase P8):** 3 gaps di-address. tsc: 0, lint: 0, build: OK (99.1 kB).
  ...
  - ✅ Gap 3 (Rapor sections B-G): Added 6 sections to `RaporModal.tsx` as SIMULASI bertanda: B (Muatan Lokal), C (Ekstrakurikuler), D (Ketidakhadiran), E (Catatan Guru Mapel), F (Deskripsi Perkembangan), G (Pengesahan). **REMAINING:** Backend data for sections B-G belum tersedia — all sections use demo data with SIMULASI badge.
