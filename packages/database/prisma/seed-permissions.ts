...
const PERMISSIONS: PermissionDef[] = [
  ...
  { code: 'remedial.child.read', description: 'Melihat remedial anak (ORANG_TUA)', module: 'academic' },
  ...
  { code: 'report.manage', description: 'Pemulihan administratif rapor (SA)', module: 'academic' },
  { code: 'report.review', description: 'Periksa/kembalikan rapor (Waka Kurikulum)', module: 'academic' },
  { code: 'report.publish', description: 'Persetujuan final dan penerbitan rapor (KS)', module: 'academic' },
  { code: 'report.distribute', description: 'Distribusi rapor terbit (TU/KS)', module: 'academic' },
  { code: 'report.recover', description: 'Pemulihan administratif rapor dengan referensi insiden (SA)', module: 'academic' },
  { code: 'report.wali.manage', description: 'Menyiapkan draft rapor kelas wali', module: 'academic' },
  ...
  { code: 'rpp.review', description: 'Permission review Modul Ajar legacy', module: 'academic' },
  { code: 'rpp.curriculum.review', description: 'Review kurikulum dan rekomendasi Modul Ajar', module: 'academic' },
  { code: 'rpp.final.approve', description: 'Persetujuan final Modul Ajar', module: 'academic' },
...
const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  TATA_USAHA: [
    ...
    'academic.teaching.read', 'academic.teaching.manage',
    'academic.schedule.read', 'academic.schedule.manage',
    'report.read', 'report.distribute', 'activity.read',
  ...
  GURU: [
    ...
    'academic.remedial.manage', 'academic.remedial.read', 'ai.chat',
    'report.read', 'report.wali.manage', 'activity.read', 'activity.manage',
  ],
  SISWA: [
